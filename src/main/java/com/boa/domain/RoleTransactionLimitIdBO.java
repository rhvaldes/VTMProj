...
public class RoleTransactionLimitIdBO implements java.io.Serializable {
	...
	public RoleTransactionLimitIdBO() {
	}

	public RoleTransactionLimitIdBO(int roleId, int limitId, int transactionId) {
		this.roleId = roleId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RoleTransactionLimitIdBO))
			return false;
		RoleTransactionLimitIdBO castOther = (RoleTransactionLimitIdBO) other;
