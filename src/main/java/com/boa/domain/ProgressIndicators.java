 ...
 */
public class ProgressIndicators implements java.io.Serializable {
	...
	public ProgressIndicators(short indicatorId) {
		this.indicatorId = indicatorId;
	}

	public ProgressIndicators(short indicatorId, String indicatorName,
