...
/**
 * Home object for domain model class RoleTransactionLimit.
 * @see .RoleTransactionLimit
 * @author Hibernate Tools
 */
public class RoleTransactionLimitHome {

	private static final Log log = LogFactory
			.getLog(RoleTransactionLimitHome.class);
	...
	public List findByExample(RoleTransactionLimitBO instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("RoleTransactionLimit")
