...
/**
 * Home object for domain model class Priorities.
 * @see .Priorities
 * @author Hibernate Tools
 */
public class PrioritiesHome {

	private static final Log log = LogFactory.getLog(PrioritiesHome.class);
	...
	public List findByExample(Priorities instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("Priorities").add(Example.create(instance))
					.list();
